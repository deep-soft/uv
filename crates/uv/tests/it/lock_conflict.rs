  ...
  [
    ...
    insta::with_settings!({
        ...
        dependencies = [
            ...
            { name = "idna", version = "3.5", source = { registry = "https://pypi.org/simple" }, marker = "(extra == 'extra-6-proxy1-x2' and extra == 'extra-7-project-x1') or extra == 'extra-6-proxy1-x3' or (extra != 'extra-6-proxy1-x2' and extra != 'extra-7-project-x1')" },
...
fn jinja_no_conflict_markers1() -> Result<()> {
    ...
    // We pin our versions anyway, so this should be fine.
